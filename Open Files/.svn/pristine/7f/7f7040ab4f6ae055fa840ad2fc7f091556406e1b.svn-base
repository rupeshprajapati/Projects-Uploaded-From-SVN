IF EXISTS(SELECT * FROM SYSOBJECTS WHERE XTYPE='P' AND [NAME]='Usp_DataExport_City_Master')
BEGIN
	DROP PROCEDURE Usp_DataExport_City_Master
END
...
-- DESCRIPTION:	THIS STORED PROCEDURE IS USEFUL TO EXPORT CITY MASTER.
-- MODIFIED BY: 
-- MODIFY DATE: 
-- REMARK:
-- =============================================

CREATE Procedure [dbo].[Usp_DataExport_City_Master]
