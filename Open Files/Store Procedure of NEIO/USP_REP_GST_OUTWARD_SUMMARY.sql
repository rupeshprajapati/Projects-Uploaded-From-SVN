...
--where Entry_ty in('ST','S1','EI','SR','GD','GC','C6','D6','PT','P1','PR','E1')  --Commented by Priyanka B on 23042019 for Bug-32425
where Entry_ty in('ST','S1','EI','SR','GD','GC','C6','D6','PT','P1','PR','E1','M3','M6')  --Modified by Priyanka B on 23042019 for Bug-32425
open Lother_cursor
...
--SELECT * INTO AAA FROM #tmpChrgtbl
	...
	where 
	--a.entry_ty in('st','ei') and --Commented by Priyanka B on 23042019 for Bug-32425
	...
	left outer join  AC_MAST ac on (b.Ac_id =ac.Ac_id )
	where 
	--a.entry_ty IN('pt','p1') and   --Commented by Priyanka B on 23042019 for Bug-32425
	(a.CGSRT_AMT+a.SGSRT_AMT+a.IGSRT_AMT) > 0  and b.date between @sdate and @edate
	and ac.GSTIN NOT IN('UNREGISTERED')
	group by a.cgst_per,a.sgst_per,a.igst_per,a.GSTRATE,b.date,b.inv_no,b.Entry_ty,b.Tran_cd,c.code_nm
